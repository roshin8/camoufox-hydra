...
Hard fork of [Camoufox](https://github.com/daijro/camoufox) (Firefox with 19+ C++ engine patches) + a bundled extension (Hydra Shield) for container management and fingerprint configuration.
...
Camoufox solves these at the C++ level, but lacks container support and daily-driver features. Hydra adds both.
...
│                                                  │
│  Config: policies.json + hydra.cfg               │
...
├── config/             # policies.json, hydra.cfg, chrome.css
├── extension/          # Hydra Shield (TypeScript, React)
│   ├── src/
│   │   ├── background/ # Container manager, config injector
│   │   ├── inject/     # Camoufox bridge, fingerprint monitor
│   │   ├── content/    # MAIN ↔ ISOLATED world bridge
│   │   ├── popup/      # React UI (6 tabs)
...
- Hydra Shield extension scaffold with 32 passing tests
